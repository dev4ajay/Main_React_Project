    ...
    <>
      ...
      <Grid container className="sm:px-0 md:px-0 lg:px-44 py-8 text-justify">
        <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
          ...
          <p>
            The distance between Delhi, and Manali, HP is approximately 306.25
            kilometers. Tripecca will ensure a comfortable journey as you travel
            by car. The estimated travel time for this route is around 7 hours
            and 25 minutes. The route from Delhi to Manali typically involves
            traveling on NH205 and NH3. Our drivers are well-versed with this
            route and will navigate through any mild traffic congestion that may
            occur.
          </p>
          <br />
        ...
        <Grid item xs={12} sm={12} md={7} lg={7} xl={7} className="relative">
          <div className="py-8 text-justify">
            ...
            <p>
              ...
              you can consider while traveling from Delhi to Manali. Each route
              offers its own set of attractions and scenic spots. Our packages
              are designed to provide you with a comprehensive experience of the
              region, allowing you to explore local markets, try local cuisine,
              and enjoy the natural beauty of the area. For more information
              about the Delhi to Manali route and our packages, please visit our
              website and feel free to call!
            </p>
          </div>
        </Grid>
