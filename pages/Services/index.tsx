...
export default function Service() {
  ...
  return (
    <>
      ...
      <Grid container className="hidden sm:hidden md:hidden lg:block xl:block">
        <Grid
          item
          xs={12}
          sm={12}
          ...
          lg={9}
          xl={9}
          className="relative sm:relative md:relative lg:absolute xl:absolute  z-50 left-0 right-0 mx-5 sm:mx-5 md:mx-5 xl:mx-auto xl:lg-auto my-0 bottom-[-100px] sm:bottom-[-100px] md:bottom-[-100px] lg:bottom-[-40px]  xl:bottom-[-40px] "
        >
          <>
      ...
      <Grid container>
        <Grid item xs={12} className="text-center py-10 mt-5">
            ...
            >
              <div className="bg-white drop-shadow-md p-5 m-8 relative">
                ...
                <div className="mt-52">
                  ...
                  <p className="text-sm py-2 h-24 overflow-y-scroll color">
                    {Services.ServicesContent}
                  </p>
                  <button
                    className="rounded-md bg-[#ffb300] py-1 px-3 my-3"
                    onClick={() => router.push("/servicesdata")}
                  >
                    Read More
