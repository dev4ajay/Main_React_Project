  ...
  const [Blog, setBlog] = useState<Blog[]>([
    {
      id: "1",
      BlogUrl: Mussoorie,
      BlogMaintitel: " Known as the “Queen of the Hills”, Mussoorie hill station offers a  pleasant scenic beauty and climate.",
      Title: "Mussoorie",
      path: "/MussoorieData",
    },
    {
      id: "2",
      BlogUrl: Shimla,
      BlogMaintitel: "  If the lush evergreen surroundings with the majestic Himalayas excite you, then Shimla must be.",
      Title: "Shimla",
      path: "/ShimlaData",
    },
    {
      id: "3",
      BlogUrl: Nainital,
      BlogMaintitel: " Located in the Kumaun region of Uttrakhand, Nainital is a famous tourist attraction for its ",
      Title: "Nainital",
      path: "/NainitalData",
    },
  ]);
              ...
              <div className="bg-white drop-shadow-md p-5 m-8 relative">
                ...
                <div className="mt-40">
                  ...
                  <button
                    ...
                    onClick={() => router.push("/AirportTransfer")}
                  >
                    Read More
            ...
            >
              <div className="rounded-xl bg-white drop-shadow-md p-5 m-8 relative">
                ...
                <div>
                  ...
                  <span className=" font-black flex justify-content-center text-justify color">{Blog.BlogMaintitel}</span>
                  <button
