...
const TripPage = () => {
  ...
  const handleSubmit = async (updatedTrip) => {
    setIsLoading(true)
    try {
     const response = await axiosInstance.put(`/api/trips/trip?tripType=airport_transfer&id=${id}`, updatedTrip);
  ...
  return (
    ...
    <Grid item xs={12} sm={12} md={12} lg={6} xl={6} className="py-0 sm:py-0 md:py-0 lg:py-5 xl:py-5">
      ...
      <div className='text-end m-5'>
        ...
        <Button  variant="contained" className='bg-[#34609d] hover:bg-[#34609d] hover:opacity-50 m-0 px-5 text-white'
