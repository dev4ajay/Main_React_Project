...
export default function AddAirportTransfer() {
    ...
    onSubmit: (values) => {
      ...
      axiosInstance
        ...
        .then((response) => {
          ...
          setIsLoading(false)
          router.replace('/admin/airport-transportation-destination');
        })
        .catch((error) => {
          // Handle error
          setIsLoading(false)
          ...
          <Grid container>
            <Grid item xs={12}>
              <div className='bg-[#ecf2ff] m-5 p-7 rounded-2xl'>
                <h1 className='text-xl font-extrabold text-[#34609d] '>Add Airport Transfer</h1>
                <p className='py-2 font-semibold text-xs text-[#34609d]'>Home <FiberManualRecordIcon className='text-sm px-1' />Airtport Transfer</p>
              </div>
            </Grid>
