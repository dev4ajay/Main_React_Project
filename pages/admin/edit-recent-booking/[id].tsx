  ...
  return (
    ...
    <Grid item xs={12} sm={12} md={12} lg={6} xl={6} className="py-0 sm:py-0 md:py-0 lg:py-5 xl:py-5">
      ...
      <h4 className="text-lg py-2">Contact Number</h4>
        ...
        <div className="m-5 block sm:block md:flex lg:flex xl:flex">
        <h4 className="text-lg py-2">Trip</h4>
        <TextField
                className="ml-[auto] w-full sm:w-full md:w-[60%] lg:w-[60%] xl:w-[60%]"
                size='small'
                select
              ...
              >
                {trips.map((trip) => (
                  <MenuItem key={trip.id} value={trip.id}>
                    {`${trip.pick_location} - ${trip.drop_location}`}
                  </MenuItem>
                ))}
              </TextField>
        </div>
      ...
      >
        ...
        className="ml-[auto] w-full sm:w-full md:w-[60%] lg:w-[60%] xl:w-[60%]"
          size='small'
          value={booking.total_distance_km}
          onChange={(e) => setBooking({ ...booking, total_distance_km: e.target.value })}
        />
        </div>
        <div className="m-5 block sm:block md:flex lg:flex xl:flex">
        <h4 className="text-lg py-2">Customer Address</h4>
        <TextField
        className="ml-[auto] w-full sm:w-full md:w-[60%] lg:w-[60%] xl:w-[60%]"
          size='small'
