...
export default function AddOneWayTrip() {
          ...
          <Grid container>
            <Grid item xs={12}>
              <div className='bg-[#ecf2ff] m-5 p-7 rounded-2xl'>
                <h1 className='text-xl font-extrabold text-[#34609d] '>Add One Way Trip</h1>
                <p className='py-2 font-semibold text-xs text-[#34609d]'>Home <FiberManualRecordIcon className='text-sm px-1' />One Way Trip</p>
              </div>
            </Grid>
            ...
            <Grid item xs={12} sm={12} md={12} lg={6} xl={6} className="py-0 sm:py-0 md:py-0 lg:py-5 xl:py-5">
              ...
              <div className='m-5 block sm:block md:flex lg:flex xl:flex'>
                ...
                {/* <div className='m-5 block sm:block md:flex lg:flex xl:flex justify-end'>
            ...
            <Grid item xs={12}>
            <form onSubmit={formik.handleSubmit}>
            <div className='m-5 block sm:block md:flex lg:flex xl:flex justify-center'>
                  <Button variant='contained' color='primary' type='submit' className="bg-[#34609d] hover:bg-[#34609d] hover:opacity-75 px-5 text-white">
                    Add Trip
                  </Button>
                </div>
